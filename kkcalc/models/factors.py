...
class asf_abstract(atomic_scattering_abstract, metaclass=abc.ABCMeta):
    ...
    def betas(self) -> np.ndarray:
        ...
        raise ValueError(
            "Material density information is required to convert to Beta values."
        )
    ...
    def to_betas(
        ...
        if number_density is not None:
            return self.energies, conversions.ASF_to_betas(
                energies=self.energies,
                factors=self.factors,
    ...
    def from_betas(
        ...
        **kwargs
        ...
        factors = conversions.betas_to_ASF(
            energies, beta, number_density, density, formula_mass, stoichiometry
        )
...
class asf_re(asf):
    ...
    def calculate_complex_factors(
        ...
        **kwargs
        ...
        common_kwargs.update(kwargs)
        return asf_complex(
            re=re_extended.to_atomic_scattering_polynomial(), im=im, **common_kwargs
...
class asf_complex(asf_abstract, atomic_scattering):
    ...
    **kwargs
    ...
    def __init__(self, re: asf_re | asf, im: asf_im | asf, **kwargs):
    ...
    def from_NEXAFS(
        ...
        **kwargs
        ...
        re = asf_re.from_NEXAFS(
            energies=energies, NEXAFS=NEXAFS.real, scale_to_database=scale_to_database
        )
    ...
    def from_betas(
        ...
        **kwargs
        ...
        re = asf_re.from_betas(
            energies=energies,
            beta=beta.real,
            scale_to_database=scale_to_database,
            **kwargs,
        )
        im = asf_im.from_betas(
            energies=energies,
            beta=beta.imag,
            scale_to_database=scale_to_database,
            **kwargs,
